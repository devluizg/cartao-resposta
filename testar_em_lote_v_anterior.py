...
def main():
    ...
    print(f"========== INICIANDO TESTE EM LOTE (VERSÃO ANTERIOR) ({len(imagens)} imagens) ==========")
    ...
    for _, img_path in enumerate(imagens, 1):
        ...
        try:
            ...
            ret = multi_analyzer.analisar_cartao_multicolunas(
                ...
                sensitivity=0.3, # mesmo da versão original para teste
                threshold=150,
    ...
    if total_questoes_avaliadas > 0:
        print("\n" + "=" * 70)
        print("RESUMO FINAL DO LOTE (VERSÃO ANTERIOR):")
        print("=" * 70)
